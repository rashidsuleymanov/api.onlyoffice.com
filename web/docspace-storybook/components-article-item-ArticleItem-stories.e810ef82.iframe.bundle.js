...
`;StyledArticleItemBadgeWrapper.defaultProps={theme:themes.C6};const StyledArticleItemInitialText=(0,styled_components_browser_esm.Ay)(components_text.E)`
  ...
  font-size: ${props=>props.theme.getCorrectFontSize(props.theme.catalogItem.initialText.fontSize)};
  ...
  @media ${utils.n5} {
    ...
    font-size: ${props=>props.theme.getCorrectFontSize(props.theme.catalogItem.initialText.tablet.fontSize)};
  }
`;StyledArticleItemInitialText.defaultProps={theme:themes.C6};const StyledArticleItemText=(0,styled_components_browser_esm.Ay)(components_text.E)`
  ...
  font-size: ${props=>props.theme.getCorrectFontSize(props.theme.catalogItem.text.fontSize)};
  ...
  @media ${utils.n5} {
    ...
    font-size: ${props=>props.theme.getCorrectFontSize(props.theme.catalogItem.text.tablet.fontSize)};
...
//# sourceMappingURL=components-article-item-ArticleItem-stories.e810ef82.iframe.bundle.js.map