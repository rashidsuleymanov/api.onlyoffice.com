...
`,StyledContextMenu=styled_components_browser_esm.Ay.div`
  ...
  .p-contextmenu .scroll-body .p-menuitem {
    margin-inline-end: ${props=>`-${props.theme.scrollbar.paddingInlineEnd}`};

    @media ${utils.Hw} {
      margin-inline-end: ${props=>`-${props.theme.scrollbar.paddingInlineEndMobile}`};
    }
  }
...
//# sourceMappingURL=1548.9f0f36b7.iframe.bundle.js.map