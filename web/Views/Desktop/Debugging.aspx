...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <div id="windows" class="content active">
            ...
            <p><img class="screenshot max-width-416" alt="Windows shortcut" src="<%= Url.Content("~/content/img/desktop/windows-shortcut.png") %>" /></p>
            ...
            <ol>
                ...
                <li>
                    ...
                    <p><img class="screenshot max-width-416" alt="Windows terminal" src="<%= Url.Content("~/content/img/desktop/windows-terminal.png") %>" /></p>
                </li>
