...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>When you integrate <b>ONLYOFFICE Document Builder</b> into your C++, COM, .Net, or Python application, you can embed the code for <b>ONLYOFFICE Document Builder</b> together
    ...
    <p>Currently, the following frameworks are available: <a href="<%= Url.Action("integrationapi/c") %>">C++</a>, <a href="<%= Url.Action("integrationapi/com") %>">COM</a>, <a href="<%= Url.Action("integrationapi/net") %>">.Net</a>, <a href="<%= Url.Action("integrationapi/python") %>">Python</a>.</p>
