...
All opened scopes will be closed automatically when the builder <a href="<%= Url.Action("integrationapi/python/cdocbuilder/closefile") %>">CloseFile</a> method is called.</p>
...
<table class="table">
    ...
    <tbody>
        <tr class="tablerow">
            <td><a href="<%= Url.Action("integrationapi/python/cdocbuildercontextscope/close") %>">Close</a></td>
