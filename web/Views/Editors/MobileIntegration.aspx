...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <note>请注意，ONLYOFFICE移动web编辑器仅适用于 <a href="https://www.onlyoffice.com/zh/docs-enterprise.aspx?from=api" target="_blank">企业</a> 和 <a href="https://www.onlyoffice.com/zh/developer-edition.aspx" target="_blank">开发者</a> 版本的商业版本。</note>
    <div class="container">
        <ul class="browser">
        ...
        <div id="ios" class="content active">
            ...
            <ol>
                <li>下载并安装ONLYOFFICE 文档 <a href="https://www.onlyoffice.com/zh/docs-enterprise.aspx?from=api" target="_blank">企业</a> 或 <a href="https://www.onlyoffice.com/zh/developer-edition.aspx" target="_blank">开发者</a> 版本。</li>
