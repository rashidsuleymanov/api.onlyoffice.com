...
<table class="table">
    ...
    <tbody>
        <tr>
            ...
            <td>定义要打开的文档类型：
                <ul>
                    <li><b>word</b> - 文本文档 （<em>.doc、.docm、.docx、.docxf、.dot、.dotm、.dotx、.epub、.fb2、.fodt、.htm、.html、.mht、.mhtml、.odt、.ott、.rtf、.stw、.sxw、.txt、.wps、.wpt、.xml</em>），</li>
                    ...
                    <li><b>pdf</b> - 便携式文档格式 （<em>.djvu、.docxf、.oform、.oxps、.pdf、.xps</em>）。</li>
                </ul>
            </td>
            <td>string</td>
            <td>"cell"</td>
