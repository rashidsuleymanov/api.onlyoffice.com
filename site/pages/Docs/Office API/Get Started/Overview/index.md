...
Office API is the JavaScript library which is used to work with the document editor. It contains classes and methods for every document type: [Text document API](../../Office%20API/Text%20Document%20API/index.mdx), [Spreadsheet API](../../Office%20API/Spreadsheet%20API/index.mdx), [Presentation API](../../Office%20API/Text%20Document%20API/index.mdx), and [Form API](../../Office%20API/Form%20API/index.mdx).
