...
Add a script to initialize the [System](../../../JavaScript%20SDK/Initialization%20Modes/System/index.md) mode.
...
* Initialize the **System** mode with the [initSystem](../../../JavaScript%20SDK/Methods/index.md#initsystem) method:
...
Add the **onButtonClick()** event handler for the button. Using the [getHashSettings](../../../JavaScript%20SDK/Methods/index.md#gethashsettings) method, return the password hash settings
and generate the password hash using the [createHash](../../../JavaScript%20SDK/Methods/index.md#createhash) method. After this, authorize the user using the [login](../../../JavaScript%20SDK/Methods/index.md#login) method:
