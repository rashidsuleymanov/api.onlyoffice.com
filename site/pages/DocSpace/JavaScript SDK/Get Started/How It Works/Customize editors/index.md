...
Add a script to initialize the [editors](../../../JavaScript%20SDK/Initialization%20Modes/Editor/index.md).
...
* Create a configuration for the **Editor** mode. Go to the [customization](../../../JavaScript%20SDK/Config/index.md#editorcustomization) section and configure the editors as needed.
...
* Initialize the <b>Editors</b> mode with the [initEditor](../../../JavaScript%20SDK/Methods/index.md#initeditor) method:
